...
class purchase_order_line(osv.osv):
    ...
    def unlink(self, cr, uid, ids, context=None):
        ...
        if procurement_ids_to_except:
            proc_pool = self.pool['procurement.order']
            proc_pool.message_post(cr, uid, procurement_ids_to_except, body=_('Purchase order line deleted.'), context=context)
            proc_pool.write(cr, uid, procurement_ids_to_except, {'state': 'exception'}, context=context)
